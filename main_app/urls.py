...
urlpatterns = [
  ...
  path('art-and-music/add_music/', views.MusicCreate.as_view(), name='music_create'),
  ...
  path('art-and-music/art/<int:pk>/delete_photo/', views.GalleryImageDelete.as_view(), name='delete_photo'),
